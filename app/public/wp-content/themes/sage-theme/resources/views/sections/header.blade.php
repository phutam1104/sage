...
<x-hello />
<x-hello class="text-red-500 bg-blue-500">
  <span>News</span>
</x-hello>
{{-- <x-btnPrimary  href="https://example.com" type="primary">
  <span>tai</span>
</x-btnPrimary> --}}
<x-button type="secondary" href="/some-link">
  Click Me
</x-button>
<x-button href="/some-link">
  Click Me
</x-button>
<header class="bg-green-apk w-full ds:bg-white sticky top-0 border-b">
  ...
  <div class="flex items-center justify-between p-4 ds:p-0 ds:mx-auto ds:w-11/12">
      ...
      <div>
          <a href="{{ home_url('/') }}" class="ds:hidden">{!! wp_get_attachment_image($siteLogo) !!}</a>
          <a href="{{ home_url('/') }}" class="hidden ds:block">{!! wp_get_attachment_image($siteLogo) !!}</a>
      </div>
      ...
      <div id="header__nav" class=" flex ds:w-full w-auto">
          <div id="header__nav__desktop" class="header__nav__desktop ds:flex  hidden ds:items-center ds:ml-8">
              ...
              <div class="nav__item p-3 flex">
                  ...
                  <a class="ml-2" href="{{ home_url('/') }}"><span>Home</span></a>
              </div>
